...
export default function UserProfilePage({ params }: UserProfilePageProps) {
  ...
  const { profile: targetProfile, loading, error } = usePublicProfile(userId);
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {!isOwnProfile && (
                <>
                  <button className="px-4 py-2 bg-green-600 text-white rounded-full hover:bg-green-700 transition-colors font-medium flex items-center gap-2">
                    <Mail className="h-4 w-4" />
                    Message
                  </button>
                  {isWorker && (
                    <button className="px-4 py-2 border border-gray-300 text-gray-700 rounded-full hover:bg-gray-50 transition-colors flex items-center gap-2">
