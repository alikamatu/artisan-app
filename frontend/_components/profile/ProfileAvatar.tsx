...
export default function ProfileAvatar({ profile, isOwnProfile = false, onEdit }: ProfileAvatarProps) {
  return (
    <div className="relative">
      <div className="relative w-28 h-28 bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl flex items-center justify-center text-white text-3xl font-bold">
